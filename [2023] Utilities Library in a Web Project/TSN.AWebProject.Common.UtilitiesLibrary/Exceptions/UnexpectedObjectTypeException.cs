...
{
    [Serializable]
    public class UnexpectedObjectTypeException : Exception, ISerializable
    {
        ...
        {
            _objectName = objName.TrimDeeperEvenIfNull();
        ...
        protected UnexpectedObjectTypeException(SerializationInfo info, StreamingContext context) : base(info, context) { }
